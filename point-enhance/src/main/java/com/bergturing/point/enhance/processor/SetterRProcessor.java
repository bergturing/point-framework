...
import static com.bergturing.point.enhance.constants.AnnotationConstants.*;
import static com.bergturing.point.enhance.utils.ProcessorUtils.cloneJCVariableAsParam;
...
public class SetterRProcessor extends AbstractProcessor {
    ...
    private JCTree.JCMethodDecl generateSetterRDecl(JCTree.JCVariableDecl jcVariableDecl) {
        ...
        return treeMaker.MethodDef(
                ...
                List.nil(),
                // 参数列表
                List.of(cloneJCVariableAsParam(treeMaker, jcVariableDecl)),
                //异常列表
                List.nil(),
                // 方法体
                block,
    ...
    private Name getMethodName(Name name) {
        // 返回生成的方法名
        return names.fromString(SET + StringUtils.toUpperCaseFirstOne(name.toString()) + METHOD_SUFFIX);
    }
}
