...
import static com.bergturing.point.utils.StringUtils.toUpperCaseFirstOne;
...
public class EntityUtils {
    ...
    public static <T> Object getDataValue(T source, String fieldName) {
        ...
        try {
            // 获取字段对应的get方法
            Method getMethod = source.getClass().getDeclaredMethod("get" + toUpperCaseFirstOne(fieldName));
    ...
    public static <S, V> Object setDataValue(S source, String fieldName, V value) {
        ...
        try {
            //获取当前字段的set方法
            Method setMethod = source.getClass().getDeclaredMethod("set" + toUpperCaseFirstOne(fieldName), value.getClass());
            // 获取set方法
